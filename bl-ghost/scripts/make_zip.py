...
def  main():
  ...
  installer = "\installer\bl-ghost-v" + FULLVERSIONSTR + "-Installer.exe"
   
  if demo:
    installer = "\installer\bl-ghost-v" + FULLVERSIONSTR + "[DEMO]" + "-Installer.exe"
  ...
  FILES_TO_ZIP = [
    ...
    projectpath + "\installer\license.rtf",
    projectpath + "\manual\bl-ghost_manual-EN.pdf" 
  ]

  ZIPNAME = "bl-ghost-v" + FULLVERSIONSTR + "-win.zip"
  
  if demo:
    ZIPNAME = "bl-ghost-v" + FULLVERSIONSTR + "[DEMO]-win.zip"
