...
def main():
  ...
  plistpath = scriptpath + "/resources/bl-ghost-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/bl-ghost-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/bl-ghost-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/bl-ghost-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/bl-ghost-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/bl-ghost.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/bl-ghost.iss",inplace=1):
