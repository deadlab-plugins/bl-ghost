...
#endif
#if 1
    BL_FLOAT a = (pow(10.0, 0.5) - 1.0)/LOG_CENTER_FREQ;
    BL_FLOAT lMin = std::log10(1.0 + minValue*a);
    BL_FLOAT lMax = std::log10(1.0 + maxValue*a);
#endif
...
#endif
#if 1
    BL_FLOAT t0 = log((BL_FLOAT)1.0 + value*(exp(LOG_SCALE2_FACTOR) - 1.0))/LOG_SCALE2_FACTOR;
#endif
...
#endif
#if 1
    BL_FLOAT t0 = (exp(value*LOG_SCALE2_FACTOR) - 1.0)/
...
#endif
#if 1
    BL_FLOAT coeff2 = exp(LOG_SCALE2_FACTOR) - 1.0;
#endif
...
#endif
#if 1
        x = log((BL_FLOAT)1.0 + x*coeff2)*coeffInv;
#endif
...
#endif
#if 1
    BL_FLOAT coeffInv = 1.0/exp(LOG_SCALE2_FACTOR - 1.0);
#endif
